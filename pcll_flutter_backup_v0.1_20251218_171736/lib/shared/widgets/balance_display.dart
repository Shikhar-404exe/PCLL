 ...
 * ======================
 * 
 * Hero component showing current cognitive balance.
 * Ledger-style, serious presentation.
 */
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              animate
                  ? _AnimatedBalance(value: balance, color: balanceColor)
                  : Text(
...
class _AnimatedBalance extends StatefulWidget {
  ...
  const _AnimatedBalance({required this.value, required this.color});
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        return Text(
          ...
          style: PCLLTypography.displayLarge.copyWith(color: widget.color),
        );
      },
    );
  }
