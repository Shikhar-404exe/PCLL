 ...
 * A productivity tracking tool using banking metaphor
 * 
 * Design Principles:
 * - Serious, neutral, analytical tone
 * - Ledger/balance-sheet inspired
      ...
      child: Consumer<SettingsProvider>(
        builder: (context, settings, _) {
          return MaterialApp(
            ...
            theme: PCLLTheme.lightTheme,
            darkTheme: PCLLTheme.darkTheme,
