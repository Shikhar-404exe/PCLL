 ...
 * 
 * Design Direction:
 * - Calm, nature-inspired aesthetic
 * - Mint greens and warm woody browns
 * - Soft, organic feel with gentle contrasts
 * - Both light and dark modes for comfort
 * 
 * Color Philosophy:
 * - Mint greens for freshness and calm
 * - Warm browns/woods for grounding
 * - Soft sage for subtle accents
 * - Natural palette that feels restful
 */
