 ...
 * ===========================
 * 
 * Analyzes ledger data to find correlations and patterns.
 * 
 * IMPORTANT: This service provides OBSERVATIONS, not suggestions.
 * - Shows what was different between positive and deficit periods
 * - Uses "associated with" language, never "caused by"
 * - User interprets their own patterns
 * - Available only after 30 days of data to prevent false patterns
 */
